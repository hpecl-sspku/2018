...
if __name__ == '__main__':
    ...
    print(result_str.decode("utf-8").encode("gbk"))
    print(json.loads(result_str)['result'][0].decode("utf-8").encode("gbk"))
    ...
    if content:
        ...
        print '用户问: '.decode("utf-8").encode("gbk")+ query.decode("utf-8").encode("gbk")
        print 'BOT答复: '.decode("utf-8").encode("gbk") + data['result']['response']['action_list'][0]['say'].decode("utf-8").encode("gbk")
        print '意图: '.decode("utf-8").encode("gbk") + intent.encode('utf-8')
    # # ===================== 调用Falsk API接口 =====================
